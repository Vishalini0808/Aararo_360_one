...
const VisionMission = () => {
  return (
    <section className=" bg-gradient-to-br from-gray-50 via-white to-blue-50/30  mb-8 flex items-center">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="lg:col-span-4">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm h-full">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-blue-500/10 to-blue-600/20 rounded-2xl flex items-center justify-center mr-4">
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-4 lg:order-2">
            <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm h-full">
              <div className="flex items-center mb-4">
                <div className="w-14 h-14 bg-gradient-to-br from-purple-500/10 to-purple-600/20 rounded-2xl flex items-center justify-center mr-4">
